<section class="home-hero">
    ...
    <h2 class="home-hero-title">코리아 통번역 센터<br>대한민국 대표<br>언어 전문<br class="display"> 서비스 기업</h2>
...
<section class="home-section home-section__project" style="background-color: #8188fe; padding:50px 0;">
    <div class="ms">
        <div class="ms1">
            상담부터 완료까지 <br class="rightnow">전문 PM이 함께 합니다.
        </div>
        <div class="ms2">
...
<section class="home-section home-section__portfolio">
    <div class="bc-container">
        ...
        <?php foreach ( $portfolioes as $portfolio ): ?>
            <li class="home-portfolio__item" style="cursor:pointer;" onclick="location.href='/translation_order/list'">
