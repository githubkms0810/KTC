...
//의존성 ::
class Freelancer_translation_language_m extends Pagination_Model 
{
	...
	{
		$this->table = "freelancer_translation_language";
		$this->as = "f_t_l";
		parent::__construct();
	}
	...
	public function createTable ()
	{
		...
		`created` datetime NOT NULL DEFAULT NOW(),
			...
			-- KEY `idx_@` (`@`),				
	CONSTRAINT `freelancerTranslationlanguage_freelancer_id` FOREIGN KEY (`freelancer_id`) REFERENCES freelancer(`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE
	,
